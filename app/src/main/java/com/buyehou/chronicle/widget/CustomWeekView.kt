...
class CustomWeekView(context: Context) : WeekView(context) {
    ...
    init {
        ...
        mTextPaint.color = 0xffffffff.toInt()
        mTextPaint.isAntiAlias = true
        mTextPaint.isFakeBoldText = true

        mSolarTermTextPaint.color = 0xff489dff.toInt()
        ...
        mCurrentDayPaint.color = 0xffeaeaea.toInt()
    ...
    override fun onDrawText(
        ...
        if (isSelected) {
            ...
            canvas.drawText(
                ...
                else if (!TextUtils.isEmpty(calendar.solarTerm)) mSolarTermTextPaint
